...
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(TestBotConnection.App_Start.NinjectWebCommon), "Stop")]

namespace TestBotConnection.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                ////kernel
                ////    .Rebind<DefaultModelValidatorProviders>()
