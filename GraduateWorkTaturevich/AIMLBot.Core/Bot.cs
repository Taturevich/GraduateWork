...
namespace AIMLbot
{
    ...
    public class Bot
    {
        ...
        public string PathToAIML
        {
            get
            {
                string pathaiml= @"~\" + GlobalSettings.grabSetting("aimldirectory");
                return System.Web.Hosting.HostingEnvironment.MapPath(pathaiml);
            }
        }
        ...
        public string PathToConfigFiles
        {
            get
            {
                string pathToconfigdirectory = @"~\" + GlobalSettings.grabSetting("configdirectory");
                pathToconfigdirectory = System.Web.Hosting.HostingEnvironment.MapPath(pathToconfigdirectory);
        ...
        public void loadSettings()
        {
            ...
            string pathToSettings = @"~\config\Settings.xml";
            pathToSettings = System.Web.Hosting.HostingEnvironment.MapPath(pathToSettings);
        ...
        public void writeToLog(string message)
        {
            ...
            if (!object.Equals(null, WrittenToLog))
            {
                WrittenToLog();
            }
        }
